...
//
// Solidity: function pendingStatus(uint256 blockNum, uint256 logIndex, bytes32 eventHash) constant returns(uint256 gasPrice, uint256 total, uint256 valid, uint256 invalid)
func (_IConfirmations *IConfirmationsCaller) PendingStatus(opts *bind.CallOpts, blockNum *big.Int, logIndex *big.Int, eventHash [32]byte) (struct {
	GasPrice *big.Int
	Total    *big.Int
	Valid    *big.Int
	Invalid  *big.Int
	...
	out := ret
	err := _IConfirmations.contract.Call(opts, out, "pendingStatus", blockNum, logIndex, eventHash)
	return *ret, err
}
...
//
// Solidity: function pendingStatus(uint256 blockNum, uint256 logIndex, bytes32 eventHash) constant returns(uint256 gasPrice, uint256 total, uint256 valid, uint256 invalid)
func (_IConfirmations *IConfirmationsSession) PendingStatus(blockNum *big.Int, logIndex *big.Int, eventHash [32]byte) (struct {
	GasPrice *big.Int
	Total    *big.Int
	Valid    *big.Int
	Invalid  *big.Int
}, error) {
	return _IConfirmations.Contract.PendingStatus(&_IConfirmations.CallOpts, blockNum, logIndex, eventHash)
}

// PendingStatus is a free data retrieval call binding the contract method 0x6e06676b.
//
// Solidity: function pendingStatus(uint256 blockNum, uint256 logIndex, bytes32 eventHash) constant returns(uint256 gasPrice, uint256 total, uint256 valid, uint256 invalid)
func (_IConfirmations *IConfirmationsCallerSession) PendingStatus(blockNum *big.Int, logIndex *big.Int, eventHash [32]byte) (struct {
	GasPrice *big.Int
	Total    *big.Int
	Valid    *big.Int
	Invalid  *big.Int
